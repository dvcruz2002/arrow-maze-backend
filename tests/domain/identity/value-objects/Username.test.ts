...
describe("Username", () => {
  describe("create", () => {
    ...
    it("should_throw_invalid_argument_error_when_username_is_too_short", () => {
      expect(() => Username.create("ab")).toThrow(InvalidArgumentError);
    });

    it("should_throw_invalid_argument_error_when_characters_are_invalid", () => {
      expect(() => Username.create("bad-name!")).toThrow(InvalidArgumentError);
    });
